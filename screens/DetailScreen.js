  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.secondary }}>
      <ImageBackground
        ...
        imageStyle={{
          transform: [{ translateY: SIZES.height - SIZES.height * 1.125 }],
        }}
      >
        ...
        >
          ...
          >
            <Text style={styles.paragraph}>
              {Data.events[itemId].description}
            </Text>
            <View style={styles.span2}>
              <Image source={images.gps_icon} style={styles.spanIcon} />
              <Text style={styles.bold}>
                {Data.events[itemId].kmAway} from here
              </Text>
            </View>
